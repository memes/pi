...
func RegisterPiServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PiServiceServer) error {
	...
	mux.Handle("GET", pattern_PiService_GetDigit_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v2.PiService/GetDigit", runtime.WithHTTPPathPattern("/api/v2/digit/{index}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PiService_GetDigit_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterPiServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PiServiceClient) error {
	...
	mux.Handle("GET", pattern_PiService_GetDigit_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/api.v2.PiService/GetDigit", runtime.WithHTTPPathPattern("/api/v2/digit/{index}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PiService_GetDigit_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
